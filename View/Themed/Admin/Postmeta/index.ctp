<div class="postmeta index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $postmetum['Postmetum']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $postmetum['Postmetum']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $postmetum['Postmetum']['id']), array(), __('Are you sure you want to delete # %s?', $postmetum['Postmetum']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
