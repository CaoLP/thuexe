...
<?php echo $this->Form->create('TourSchedule'); ?>
	<fieldset>
		<legend><?php echo __('Edit Tour Schedule'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TourSchedule.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('TourSchedule.id'))); ?></li>
